...
function VideosLista(){
    ...
    const Opcoes=(props:any)=>{
        ...
        const onPublicChange=useCallback((e:any)=>{
            auth.post(server+"/admin/videos_lista"+location.search,{type:"option",id:props.post.id,operation:e.target.checked ? "publico":"privado"}).then((result:resultInterface)=>{
