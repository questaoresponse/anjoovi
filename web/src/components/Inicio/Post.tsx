    ...
    return (
        <div onScroll={verifyScroll || (()=>{})} id="tabela" className='p-0 postc'>
            {posts.map((post:any,index:number)=>{
                ...
                content=t ? <div className='titulo a txt'>{parts.map((part:string,index:number)=>{
                ...
                })}</div> : <div style={{aspectRatio:mobile ? "initial" : "16/9"}} className='imagemd'>
                    <div style={{
