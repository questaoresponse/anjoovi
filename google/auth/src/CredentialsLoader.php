...
require __DIR__ . '/FetchAuthTokenInterface.php';
require __DIR__ . '/GetUniverseDomainInterface.php';
require __DIR__ . '/UpdateMetadataInterface.php';
require __DIR__ . '/UpdateMetadataTrait.php';
