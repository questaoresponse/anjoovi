...
require __DIR__ . '/../CredentialsLoader.php';
require __DIR__ . '/../ServiceAccountSignerTrait.php';
require __DIR__ . '/../GetQuotaProjectInterface.php';
require __DIR__ . '/../SignBlobInterface.php';
require __DIR__ . '/../ProjectIdProviderInterface.php';
